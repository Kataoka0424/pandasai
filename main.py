...
if not uploaded_file.empty:
    ...
    prompt_dict = {
        ...
        - 2021年10月1日から2022年9月30日までを79期とします。- 2022年10月1日から2023年9月30日までを80期とします。',
        '表: 月毎': '下記の条件を考慮して表示してください。#表示内容は表形式#条件- 得意先名は「オツタカ」を含んだ名称\
        - 2021年10月1日から2022年9月30日までを79期とします。- 2022年10月1日から2023年9月30日までを80期とします。\
        - 月毎の金額の合計',
        'グラフ: 月毎': '下記の条件を考慮して表示してください。#表示内容は折れ線グラフ#条件- \
        - 2021年10月1日から2022年9月30日までを79期とします。- 2022年10月1日から2023年9月30日までを80期とします。\
        得意先名は「オツタカ」を含んだ名称- 月毎の金額の合計- グラフは79期と80期を分ける',
        '棒グラフ: 得意先別の金額合計': '下記の条件を考慮して表示してください。#表示内容は棒グラフ#条件\
        - ７月の金額の合計\
        - 2021年10月1日から2022年9月30日までを79期とします。- 2022年10月1日から2023年9月30日までを80期とします。\
        - 金額の上位10件を表示- グラフは79期と80期を分ける'
          }
